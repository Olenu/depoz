...
double s=a+a*p/12/100*sr; //формула дл€ вычислени€ 
textField_2.setText(String.valueOf(s)); 
}
else
{ 
double s1=a*Math.pow (1+sr*p/12/100,sr);
...
lblNewLabel_3 = new JLabel("\u0421\u0440\u043E\u043A \u0432\u043B\u043E\u0436\u0435\u043D\u0438\u044F, \u043C\u0435\u0441"); //объ€вл€ютс€ текстовые строки
...
JLabel lblNewLabel_4 = new JLabel("\u0421\u0443\u043C\u043C\u0430 \u043D\u0430 \u043A\u043E\u043D\u0435\u0446 \u0441\u0440\u043E\u043A\u0430");  //объ€вл€ютс€ текстовые строки
